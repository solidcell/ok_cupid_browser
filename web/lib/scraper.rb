...
DB.execute "CREATE TABLE IF NOT EXISTS profiles (
            ...
            status Varchar(64))"
DB.execute "CREATE TABLE IF NOT EXISTS pictures (username varchar(128)  NOT NULL,
            size varchar(32) NOT NULL,
            url varchar(256) NOT NULL)"
DB.execute "CREATE TABLE IF NOT EXISTS raw_profiles (`username` varchar(128) NOT NULL,
            `page` TEXT NOT NULL,
